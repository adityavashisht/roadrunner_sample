...
<script>
    ...
    $(function () {
        var isTravelTime = $("#timeToTravelValue").text();
        var selectedDate = $("#travelDate").val();
        if (isTravelTime.indexOf("mins") == -1 && selectedDate != undefined) {
            getTravelTime();
        }
    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (timeToTravelMinutes != undefined) {
                        ...
                        if (routeType != undefined && routeType == 'F') {
                            getArrivalPickUp();
                        }
                        else if (routeType != undefined && routeType == 'T') {
